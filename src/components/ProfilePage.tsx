            ...
            <div className="px-6">
              <div className="flex justify-center">
                <img
                  ...
                  className="shadow-xl rounded-full h-40 align-middle border-8 border-blue-light absolute -m-16  lg:-ml-16 max-w-150-px"
                />
              ...
              <div className="mt-4 py-4 mb-4 border-t border-darkBlue-default text-center">
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-9/12 px-4">
                    <h1 className="text-2xl font-bold text-blue-default mb-2">
                      Highlight Reel
                    </h1>
                    <div>
                      ...
                      <div className="w-full flex flex-col justify-evenly mb-2 ">
                        <div className="transform transition duration-500 hover:scale-110 text-center mx-20 text-white-cream  bg-darkBlue-default shadow-2xl rounded-lg border-blue-light border-4 mb-4">
                          {edit === true ? (
                            <span className="inline-flex mt-0 -mb-8 text-xl">
                              <BiEdit
                                className="text-2xl"
                                onClick={() =>
                                  setHighlight1(
                                    editHighlight1 === false ? true : false
                                  )
                                }
                              />
                            </span>
                          ...
                          {edit === true ? (
                            <span className="inline-flex mt-0 -mb-8 text-xl">
                              <BiEdit
                                ...
                                onClick={() =>
                                  setHighlight2(
                                    editHighlight2 === false ? true : false
                                  )
                                }
                              />
                            </span>
                          ...
                          {edit === true ? (
                            <span className="inline-flex mt-0 -mb-8 text-xl">
                              <BiEdit
                                ...
                                onClick={() =>
                                  setHighlight3(
                                    editHighlight3 === false ? true : false
                                  )
                                }
                              />
                            </span>
                          ...
                          {edit === true ? (
                            <span className="inline-flex mt-0 -mb-8 text-xl">
                              <BiEdit
                                ...
                                onClick={() =>
                                  setHighlight4(
                                    editHighlight4 === false ? true : false
                                  )
                                }
                              />
                            </span>
